...
/**
 * Исключение выбрасывается при попытке удалить сущность, на которую есть ссылки у других сущностей
 * (например, удаляем product, на который ссылается некоторый sales_periods)
 */
